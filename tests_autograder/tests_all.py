...
class TestLinkedList(unittest.TestCase):
    ...
    def test_no_initial_value(self):
        """
        Test 2: A list instantiated without a data has a head with a data of None.
        """
        llist = LinkedList()
        self.assertIsNone(llist.data)

    def test_initial_value(self):
        """
        Test 3: A list/node instantiated with a data retains that data.
        """
        data = fake_value()
        llist = LinkedList(data)
        self.assertEqual(data, llist.data)
    ...
    def test_next(self):
        ...
        """
        llist = LinkedList()
        self.assertIs(llist, llist.next)
    ...
    def test_previous(self):
        ...
        """
        llist = LinkedList()
        self.assertEqual(llist, llist.previous)
    ...
    def test_sentinel_node(self):
        """
        Test 6: A list node with a data of `None` is a sentinel node.
        (See https://en.wikipedia.org/wiki/Sentinel_node)
        """
        llist = LinkedList()
        self.assertTrue(llist.is_sentinel())

    def test_not_sentinel_node(self):
        """
        Test 7: A list node with a data is not a sentinel node.
        """
        llist = LinkedList(fake_value())
        self.assertFalse(llist.is_sentinel())
    ...
    def test_not_empty(self):
        ...
        """
        llist = LinkedList()
        llist.next = fake_value()
        self.assertFalse(llist.is_empty())
        llist.previous = fake_value()
        self.assertFalse(llist.is_empty())
        llist.next = llist
        self.assertFalse(llist.is_empty())
    ...
    def test_empty_is_last_node(self):
        ...
        """
        llist = LinkedList()
        self.assertTrue(llist.is_last_node())
    ...
    def test_last_of_empty(self):
        ...
        """
        llist = LinkedList()
        self.assertEqual(llist, llist.last_node())
    ...
    def test_append_to_empty_list_sets_next_of_sentinel_to_new_node(self):
        ...
        llist.append(appendee)
        self.assertEqual(appendee, llist.next)
    ...
    def test_append_to_empty_list_sets_previous_of_sentinel_to_new_node(self):
        ...
        appendee = LinkedList(fake_value())
        llist.append(appendee)
        self.assertEqual(appendee, llist.previous)
    ...
    def test_append_to_empty_list_sets_previous_of_new_node_to_sentinel(self):
        ...
        appendee = LinkedList(fake_value())
        llist.append(appendee)
        self.assertEqual(llist, appendee.previous)
    ...
    def test_append_to_empty_list_sets_next_of_new_node_to_sentinel(self):
        ...
        appendee = LinkedList(fake_value())
        llist.append(appendee)
        self.assertEqual(llist, appendee.next)
    ...
    def test_first_of_two_nodes_is_not_last(self):
        ...
        appendee = LinkedList(fake_value())
        llist.append(appendee)
        self.assertFalse(llist.is_last_node())
    ...
    def test_last_of_two_nodes(self):
        ...
        appendee = LinkedList(fake_value())
        llist.append(appendee)
        self.assertEqual(appendee, llist.last_node())
    ...
    def test_append_to_two_node_list_next_of_sentinel_is_second(self):
        ...
        llist.append(third_node)
        self.assertEqual(second_node, llist.next)
    ...
    def test_append_to_two_node_list_previous_of_second_is_sentinel(self):
        ...
        llist.append(second_node)
        llist.append(third_node)
        self.assertEqual(llist, second_node.previous)
    ...
    def test_append_to_two_node_list_sets_next_of_third_node_to_sentinel(self):
        ...
        llist.append(second_node)
        llist.append(third_node)
        self.assertEqual(llist, third_node.next)
    ...
    def test_append_to_two_node_list_sets_previous_of_sentinel_to_third_node(self):
        ...
        llist.append(second_node)
        llist.append(third_node)
        self.assertEqual(third_node, llist.previous)
    ...
    def test_last_of_three_nodes(self):
        ...
        llist.append(second_node)
        llist.append(third_node)
        self.assertEqual(third_node, llist.last_node())
    ...
    def test_append_to_three_node_list(self):
        ...
        llist.append(second_node)
        llist.append(third_node)
        llist.append(fourth_node)
        self.assertEqual(fourth_node, llist.previous)
        self.assertEqual(llist, fourth_node.next)
    ...
    def test_at(self):
        ...
        llist.append(third_node)
        llist.append(fourth_node)
        self.assertEqual(second_node, llist.at_position(1))
        self.assertEqual(third_node, llist.at_position(2))
        self.assertEqual(fourth_node, llist.at_position(3))
    ...
    def test_search_returns_none_when_not_found(self):
        """
        Test 31: Searching for a node with a particular data that does not exist in the
        linked list returns None.
        """
        llist = LinkedList()
        second_node = LinkedList("FAKE")
        self.assertEqual(None, llist.search("X"))

    def test_search_returns_node_when_found(self):
        """
        Test 32: Searching for a node with a particular data returns that node, if it
        exists in the linked list.
        """
        data = "FAKE"
        llist = LinkedList()
        second_node = LinkedList(data)
        llist.append(second_node)
        self.assertEqual(second_node, llist.search(data))
    ...
    def test_insert_in_order_when_empty(self):
        ...
        """
        llist = LinkedList()
        llist.insert_in_order(LinkedList(8))
        self.assertEqual(None, llist.at_position(0).data)
        self.assertEqual(8, llist.at_position(1).data)

    def test_insert_in_order_less_than(self):
        """
        Test 34: Inserting a node in a sorted list when the node's data is less than an
        existing node's data places the new node before the existing one.
        Example: None -> 8 becomes None -> 6 -> 8
        """
        llist = LinkedList()
        llist.insert_in_order(LinkedList(8))
        llist.insert_in_order(LinkedList(6))
        self.assertEqual(6, llist.at_position(1).data)

    def test_insert_in_order_greater_than(self):
        """
        Test 35: Inserting a node in a sorted list when the node's data is greater than
        an existing node's data places the new node after te existing one.
        Example: None -> 8 becomes None -> 8 -> 9
        """
        llist = LinkedList()
        llist.insert_in_order(LinkedList(8))
        llist.insert_in_order(LinkedList(9))
        self.assertEqual(9, llist.at_position(2).data)

    def test_insert_in_order_maintains_order_of_values(self):
        """
        Test 36: Inserting nodes of arbitrary data results in the list maintaining the
        sorted order of nodes based on their data.
        Example: inserting 8, 6, 7, 5, 3, 0, 9 results in: 0, 3, 5, 6, 7, 8, 9
        """
        values = [8, 6, 7, 5, 3, 0, 9]
        llist = LinkedList()
        for data in values:
            llist.insert_in_order(LinkedList(data))
        self.assertEqual(None, llist.at_position(0).data)
        self.assertEqual(0, llist.at_position(1).data)
        self.assertEqual(3, llist.at_position(2).data)
        self.assertEqual(5, llist.at_position(3).data)
        self.assertEqual(6, llist.at_position(4).data)
        self.assertEqual(7, llist.at_position(5).data)
        self.assertEqual(8, llist.at_position(6).data)
        self.assertEqual(9, llist.at_position(7).data)
